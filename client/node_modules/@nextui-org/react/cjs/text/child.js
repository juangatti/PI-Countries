...
const TextChild = ({
  ...
  const Component = tag;
  const color = (0, _react.useMemo)(() => (0, _color.getNormalColor)(userColor, theme.palette), [userColor, theme.palette]);
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_react.default.Fragment, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(Component, { ...props,
      className: _style.default.dynamic([["2179963912", [tag, color, margin, weight, transform, fontSize]]]) + " " + (props && props.className != null && props.className || (0, _clsx.default)({
        'custom-size': !!size
      }, className) || ""),
      children: children
