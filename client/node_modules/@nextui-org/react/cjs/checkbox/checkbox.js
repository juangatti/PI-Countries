...
const Checkbox = ({
  ...
  const checkboxColor = (0, _react.useMemo)(() => (0, _color.getNormalColor)(color || groupColor, theme.palette), [color, groupColor, theme.palette]);
  const {
  ...
  const iconCheckStyle = (0, _styles.getIconCheckStyle)(size, indeterminate);
  ...
  const fontSize = (0, _react.useMemo)(() => (0, _styles.getCheckboxSize)(size), [size]);
