...
declare const normalSizes: ["mini", "small", "medium", "large", "xlarge"];
...
export declare const excludedInputPropsForTextarea: ["clearable", "as", "rounded", "labelLeft", "labelRight", "contentLeft", "contentRight", "contentClickable", "contentLeftStyling", "contentRightStyling", "onContentClick", "onClearClick"];
