...
exports.getNormalShadowColor = exports.invertHex = exports.addColorAlpha = exports.colorToRgbValues = exports.hexFromString = exports.hexToRgb = exports.isColor = exports.isNormalColor = exports.getNormalColor = exports.hexToRGBA = exports.isHex = void 0;
...
const getNormalColor = (color, palette, defaultColor = 'inherit') => {
  const colors = {
...
exports.getNormalColor = getNormalColor;
...
const invertHex = (hex, smooth = true) => {
  if (hex.indexOf('#') === 0) {
    hex = hex.slice(1);
...
const getNormalShadowColor = (color, palette) => {
  try {
...
exports.getNormalShadowColor = getNormalShadowColor;