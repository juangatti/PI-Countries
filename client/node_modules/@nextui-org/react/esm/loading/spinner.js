...
const getSpans = (color, theme) => {
  return [...new Array(12)].map((_, index) => /*#__PURE__*/_jsx("span", {
    className: _JSXStyle.dynamic([["2953407783", [color, theme.layout.radius]]]),
...
const Spinner = ({
  ...
  return /*#__PURE__*/_jsxs("div", { ...props,
    className: _JSXStyle.dynamic([["2453304203", [size, size]]]) + " " + (props && props.className != null && props.className || `spinner ${className}`),
    children: [/*#__PURE__*/_jsx("div", {
      "aria-label": ariaLabel,
      className: _JSXStyle.dynamic([["2453304203", [size, size]]]) + " " + "container",
      children: getSpans(color, theme)
    }), children && /*#__PURE__*/_jsx("label", {
      style: labelStyle,
      className: _JSXStyle.dynamic([["2453304203", [size, size]]]),
      children: children
...
const MemoSpinner = /*#__PURE__*/React.memo(Spinner);
